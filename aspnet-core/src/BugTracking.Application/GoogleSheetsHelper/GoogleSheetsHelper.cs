...
namespace GoogleSheetsHelper
{
    public class GoogleSheetsHelper
    {
        ...
        public readonly string sheet = "sheetName";
        private readonly SheetsService _sheetsService;
        private readonly string _spreadsheetId= "1cePdWg9TIG94xHFxoPYpl8cO_CqvzsYtxxNjrdqpP14";
        ...
        public void ReadSheet()
        {
            ...
            {
                AddRow("Name", "Description", "StartDate", "DueDate", "Status", "Assignees", "IsFisnish");
            }
        }
        public void AddRow(string name,string des,string startDate, string dueDate,string status,string assginees,string isFinish)
        {
            var range = $"{sheet}!A:G";
            var valueRange = new ValueRange();
            var oblist = new List<object>() { name, des, startDate, dueDate, status, assginees, isFinish };
