...
namespace Volo.Abp.Identity
{
    public class IdentityUserManager : UserManager<IdentityUser>, IDomainService
    {
        ...
        public virtual async Task<bool> IsInOrganizationUnitAsync(string userId, Guid ouId)
        {
        ...
        public virtual async Task AddToOrganizationUnitAsync(string userId, Guid ouId)
        {
        ...
        public virtual async Task RemoveFromOrganizationUnitAsync(string userId, Guid ouId)
        {
            var user = await UserRepository.GetAsync(userId, cancellationToken: CancellationToken);
        ...
        public virtual async Task SetOrganizationUnitsAsync(string userId, params Guid[] organizationUnitIds)
        {
