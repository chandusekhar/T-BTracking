...
namespace Volo.Abp.Users
{
    ...
    {
        public static async Task<TUser> GetByIdAsync<TUser>(this IUserLookupService<TUser> userLookupService, string id, CancellationToken cancellationToken = default)
